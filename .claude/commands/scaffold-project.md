...
Set up the complete repo skeleton for a ScribeVault project. This creates the directory structure, CLAUDE.md, agent wrappers, context documents, and output folders that all personas and skills operate within. Run this before `/compile-team` and `/seed-tasks`.
