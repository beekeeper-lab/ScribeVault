...
Claude Code slash command that runs a comprehensive health check on a ScribeVault project.
...
| `NotAScribeVaultProject` | No CLAUDE.md or ai/ directory | Verify this is a ScribeVault project |
