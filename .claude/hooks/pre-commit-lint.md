...
- **Customization:** Projects can disable individual hooks via composition spec or `.scribevault/hooks.yml`. For example, a prototype project might disable `type-check` while keeping the other three.
