...
follows the ScribeVault structure. Verifies folder expectations, required files,
...
| `NotAScribeVaultProject` | No `CLAUDE.md` or `ai/` directory found | Verify this is a ScribeVault project |
...
- `src/` -- existing validation logic for composition and library checks
- `src/export/` -- `validate_generated_project()` for structural checks
