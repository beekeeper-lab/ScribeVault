...
|----|-------|----------|--------|--------|
| BEAN-001 | Periodic Audio Checkpoint Saving | P0 | Done | bean/BEAN-001-periodic-audio-checkpoint |
...
| BEAN-031 | Fix Broken Test Suite | P0 | Unapproved | bean/BEAN-031-fix-broken-test-suite |
| BEAN-032 | Fix Hardcoded AI Model Selection | P1 | Unapproved | bean/BEAN-032-fix-hardcoded-ai-model |
| BEAN-033 | Fix WhisperService API Key Bypass | P1 | Unapproved | bean/BEAN-033-fix-whisper-api-key-bypass |
| BEAN-034 | Dead Code & Unused Import Cleanup | P1 | Unapproved | bean/BEAN-034-dead-code-unused-import-cleanup |
| BEAN-035 | Root-Level Test Files & Repo Hygiene | P1 | Unapproved | bean/BEAN-035-repo-hygiene-cleanup |
| BEAN-036 | Extract Shared Utility Functions | P2 | Unapproved | bean/BEAN-036-extract-shared-utilities |
| BEAN-037 | Unused Dependencies Cleanup | P2 | Unapproved | bean/BEAN-037-unused-dependencies-cleanup |
| BEAN-038 | Stale Documentation & UI Fixes | P3 | Unapproved | bean/BEAN-038-stale-docs-and-ui-fixes |
| BEAN-039 | Purge Git History for Publication | P0 | Unapproved | bean/BEAN-039-purge-git-history |
| BEAN-040 | Add MIT License | P1 | Unapproved | bean/BEAN-040-add-mit-license |
| BEAN-041 | Fix Dependency Version Bounds for Security | P1 | Unapproved | bean/BEAN-041-fix-dependency-version-bounds |
| BEAN-042 | Remove Legacy XOR Encryption | P2 | Unapproved | bean/BEAN-042-remove-legacy-xor-encryption |
| BEAN-043 | Comprehensive README Rewrite | P1 | Unapproved | bean/BEAN-043-comprehensive-readme-rewrite |
