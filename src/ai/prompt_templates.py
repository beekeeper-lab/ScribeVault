...
BUILTIN_TEMPLATES = [
    PromptTemplate(
        ...
        prompt_text=(
            ...
            "Analyze the following transcript and produce a clear, numbered list "
            "of action items. For each item, include WHO is responsible and WHAT "
    ...
    PromptTemplate(
        ...
        name="Key Decisions",
        prompt_text=(
            "You are an assistant that identifies key decisions from transcripts. "
            "Analyze the following transcript and extract all decisions that were "
            "made. For each decision, note the context, the decision itself, and "
    ...
    PromptTemplate(
        ...
        prompt_text=(
            ...
            "from transcripts. Organize the content into logical sections with "
...
class PromptTemplateManager:
    ...
    def _save_custom_templates(self):
        ...
        try:
            data = {"templates": [t.to_dict() for t in self._custom_templates.values()]}
    ...
    def get_all_templates(self) -> List[PromptTemplate]:
        ...
        builtin = sorted(self._builtin_templates.values(), key=lambda t: t.name)
    ...
    def save_custom_template(self, name: str, prompt_text: str) -> PromptTemplate:
