...
class TestScribeVaultIntegration(unittest.TestCase):
    ...
    def test_error_handling_integration(self):
        ...
        try:
            ...
            # Invalid category should be corrected to 'other', not rejected
            recording_id_corrected = vault.add_recording(
                filename="test.wav",
                category="invalid_category"
            )
            self.assertGreater(recording_id_corrected, 0)
    ...
    def test_database_integrity(self):
        ...
        try:
            ...
            with sqlite3.connect(vault.db_path) as conn:
                # Enable foreign keys on this connection (per-connection pragma)
